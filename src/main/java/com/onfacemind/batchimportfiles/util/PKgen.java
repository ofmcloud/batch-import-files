package com.onfacemind.batchimportfiles.util;
...
public class PKgen {
	...
	private static final Logger logger = LoggerFactory.getLogger(PKgen.class);
	...
	private synchronized static PKgen getInstance() {
	...
	private synchronized static PKgen getInstance(int suffix) {
	...
	public static void main(String[] args) throws Exception {
		...
		while (i++ < 10) {
			logger.info(pkg.nextPK());
		}
		logger.info("Time: " + (System.currentTimeMillis() - now));
	}
